...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'obkr_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'obkr_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './../', 'php', 'obkr_forums', 'obkr_posts', 'obkr_topics', 'obkr_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('obkr_captcha_questions', 'obkr_captcha_answers', 'obkr_qa_confirm');
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './../', 'php', 'obkr_notification_emails');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './../', 'php', 'obkr_user_notifications');
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'obkr_profile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'obkr_bbcodes', 'obkr_smilies', 'obkr_styles', 'obkr_words', './../styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'obkr_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'obkr_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'obkr_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'obkr_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'obkr_poll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'obkr_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'obkr_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'obkr_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './../', 'php', 'obkr_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.acl_groups' => 'obkr_acl_groups',
            'tables.acl_options' => 'obkr_acl_options',
            'tables.acl_roles' => 'obkr_acl_roles',
            'tables.acl_roles_data' => 'obkr_acl_roles_data',
            'tables.acl_users' => 'obkr_acl_users',
            'tables.attachments' => 'obkr_attachments',
            'tables.auth_provider_oauth_token_storage' => 'obkr_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'obkr_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'obkr_oauth_accounts',
            'tables.banlist' => 'obkr_banlist',
            'tables.bbcodes' => 'obkr_bbcodes',
            'tables.bookmarks' => 'obkr_bookmarks',
            'tables.bots' => 'obkr_bots',
            'tables.captcha_qa_questions' => 'obkr_captcha_questions',
            'tables.captcha_qa_answers' => 'obkr_captcha_answers',
            'tables.captcha_qa_confirm' => 'obkr_qa_confirm',
            'tables.config' => 'obkr_config',
            'tables.config_text' => 'obkr_config_text',
            'tables.confirm' => 'obkr_confirm',
            'tables.disallow' => 'obkr_disallow',
            'tables.drafts' => 'obkr_drafts',
            'tables.ext' => 'obkr_ext',
            'tables.extensions' => 'obkr_extensions',
            'tables.extension_groups' => 'obkr_extension_groups',
            'tables.forums' => 'obkr_forums',
            'tables.forums_access' => 'obkr_forums_access',
            'tables.forums_track' => 'obkr_forums_track',
            'tables.forums_watch' => 'obkr_forums_watch',
            'tables.groups' => 'obkr_groups',
            'tables.icons' => 'obkr_icons',
            'tables.lang' => 'obkr_lang',
            'tables.log' => 'obkr_log',
            'tables.login_attempts' => 'obkr_login_attempts',
            'tables.migrations' => 'obkr_migrations',
            'tables.moderator_cache' => 'obkr_moderator_cache',
            'tables.modules' => 'obkr_modules',
            'tables.notification_emails' => 'obkr_notification_emails',
            'tables.notification_types' => 'obkr_notification_types',
            'tables.notifications' => 'obkr_notifications',
            'tables.poll_options' => 'obkr_poll_options',
            'tables.poll_votes' => 'obkr_poll_votes',
            'tables.posts' => 'obkr_posts',
            'tables.privmsgs' => 'obkr_privmsgs',
            'tables.privmsgs_folder' => 'obkr_privmsgs_folder',
            'tables.privmsgs_rules' => 'obkr_privmsgs_rules',
            'tables.privmsgs_to' => 'obkr_privmsgs_to',
            'tables.profile_fields' => 'obkr_profile_fields',
            'tables.profile_fields_data' => 'obkr_profile_fields_data',
            'tables.profile_fields_options_language' => 'obkr_profile_fields_lang',
            'tables.profile_fields_language' => 'obkr_profile_lang',
            'tables.ranks' => 'obkr_ranks',
            'tables.reports' => 'obkr_reports',
            'tables.reports_reasons' => 'obkr_reports_reasons',
            'tables.search_results' => 'obkr_search_results',
            'tables.search_wordlist' => 'obkr_search_wordlist',
            'tables.search_wordmatch' => 'obkr_search_wordmatch',
            'tables.sessions' => 'obkr_sessions',
            'tables.sessions_keys' => 'obkr_sessions_keys',
            'tables.sitelist' => 'obkr_sitelist',
            'tables.smilies' => 'obkr_smilies',
            'tables.sphinx' => 'obkr_sphinx',
            'tables.styles' => 'obkr_styles',
            'tables.styles_template' => 'obkr_styles_template',
            'tables.styles_template_data' => 'obkr_styles_template_data',
            'tables.styles_theme' => 'obkr_styles_theme',
            'tables.styles_imageset' => 'obkr_styles_imageset',
            'tables.styles_imageset_data' => 'obkr_styles_imageset_data',
            'tables.teampage' => 'obkr_teampage',
            'tables.topics' => 'obkr_topics',
            'tables.topics_posted' => 'obkr_topics_posted',
            'tables.topics_track' => 'obkr_topics_track',
            'tables.topics_watch' => 'obkr_topics_watch',
            'tables.user_group' => 'obkr_user_group',
            'tables.user_notifications' => 'obkr_user_notifications',
            'tables.users' => 'obkr_users',
            'tables.warnings' => 'obkr_warnings',
            'tables.words' => 'obkr_words',
            'tables.zebra' => 'obkr_zebra',
            ...
            'tables' => [
                'acl_groups' => 'obkr_acl_groups',
                'acl_options' => 'obkr_acl_options',
                'acl_roles' => 'obkr_acl_roles',
                'acl_roles_data' => 'obkr_acl_roles_data',
                'acl_users' => 'obkr_acl_users',
                'attachments' => 'obkr_attachments',
                'auth_provider_oauth_token_storage' => 'obkr_oauth_tokens',
                'auth_provider_oauth_states' => 'obkr_oauth_states',
                'auth_provider_oauth_account_assoc' => 'obkr_oauth_accounts',
                'banlist' => 'obkr_banlist',
                'bbcodes' => 'obkr_bbcodes',
                'bookmarks' => 'obkr_bookmarks',
                'bots' => 'obkr_bots',
                'captcha_qa_questions' => 'obkr_captcha_questions',
                'captcha_qa_answers' => 'obkr_captcha_answers',
                'captcha_qa_confirm' => 'obkr_qa_confirm',
                'config' => 'obkr_config',
                'config_text' => 'obkr_config_text',
                'confirm' => 'obkr_confirm',
                'disallow' => 'obkr_disallow',
                'drafts' => 'obkr_drafts',
                'ext' => 'obkr_ext',
                'extensions' => 'obkr_extensions',
                'extension_groups' => 'obkr_extension_groups',
                'forums' => 'obkr_forums',
                'forums_access' => 'obkr_forums_access',
                'forums_track' => 'obkr_forums_track',
                'forums_watch' => 'obkr_forums_watch',
                'groups' => 'obkr_groups',
                'icons' => 'obkr_icons',
                'lang' => 'obkr_lang',
                'log' => 'obkr_log',
                'login_attempts' => 'obkr_login_attempts',
                'migrations' => 'obkr_migrations',
                'moderator_cache' => 'obkr_moderator_cache',
                'modules' => 'obkr_modules',
                'notification_emails' => 'obkr_notification_emails',
                'notification_types' => 'obkr_notification_types',
                'notifications' => 'obkr_notifications',
                'poll_options' => 'obkr_poll_options',
                'poll_votes' => 'obkr_poll_votes',
                'posts' => 'obkr_posts',
                'privmsgs' => 'obkr_privmsgs',
                'privmsgs_folder' => 'obkr_privmsgs_folder',
                'privmsgs_rules' => 'obkr_privmsgs_rules',
                'privmsgs_to' => 'obkr_privmsgs_to',
                'profile_fields' => 'obkr_profile_fields',
                'profile_fields_data' => 'obkr_profile_fields_data',
                'profile_fields_options_language' => 'obkr_profile_fields_lang',
                'profile_fields_language' => 'obkr_profile_lang',
                'ranks' => 'obkr_ranks',
                'reports' => 'obkr_reports',
                'reports_reasons' => 'obkr_reports_reasons',
                'search_results' => 'obkr_search_results',
                'search_wordlist' => 'obkr_search_wordlist',
                'search_wordmatch' => 'obkr_search_wordmatch',
                'sessions' => 'obkr_sessions',
                'sessions_keys' => 'obkr_sessions_keys',
                'sitelist' => 'obkr_sitelist',
                'smilies' => 'obkr_smilies',
                'sphinx' => 'obkr_sphinx',
                'styles' => 'obkr_styles',
                'styles_template' => 'obkr_styles_template',
                'styles_template_data' => 'obkr_styles_template_data',
                'styles_theme' => 'obkr_styles_theme',
                'styles_imageset' => 'obkr_styles_imageset',
                'styles_imageset_data' => 'obkr_styles_imageset_data',
                'teampage' => 'obkr_teampage',
                'topics' => 'obkr_topics',
                'topics_posted' => 'obkr_topics_posted',
                'topics_track' => 'obkr_topics_track',
                'topics_watch' => 'obkr_topics_watch',
                'user_group' => 'obkr_user_group',
                'user_notifications' => 'obkr_user_notifications',
                'users' => 'obkr_users',
                'warnings' => 'obkr_warnings',
                'words' => 'obkr_words',
                'zebra' => 'obkr_zebra',
            ],
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'obkr_',
